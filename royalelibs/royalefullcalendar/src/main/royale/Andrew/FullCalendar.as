package Andrew {
    ...
    public class FullCalendar extends UIBase {
        ...
        public function set defaultDate(value:Object):void {
            _defaultDate = value;
        }

        public function get defaultDate():Object {
            return _defaultDate;
        }
        ...
        public function set eventLimit(value:Boolean):void {
            _eventLimit = value;
        }

        public function get eventLimit():Boolean {
            return _eventLimit;
        }
        ...
        private function onInit(e:Event):void {
            ...
            if (_defaultView)
                options["defaultView"] = _defaultView;
            if (_defaultDate)
            ...
            _calendar = new FullCalendar.Calendar(positioner, options);
            _calendar.render();
        }
