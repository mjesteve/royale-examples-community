...
declare module '@fullcalendar/yearview' {
    export { default as SimpleDayGrid, DayGridSlicer } from '@fullcalendar/yearview/SimpleDayGrid';
    export { default as DayGrid, DayGridSeg } from '@fullcalendar/yearview/DayGrid';
    export { default as AbstractDayGridView } from '@fullcalendar/yearview/AbstractDayGridView';
    export { default as DayGridView, buildDayTable as buildBasicDayTable } from '@fullcalendar/yearview/DayGridView';
    export { default as DayBgRow } from '@fullcalendar/yearview/DayBgRow';
    export { default as DayTable, DayTableSeg, DayTableCell } from '@fullcalendar/yearview/DayTable';
    const _default: import("@fullcalendar/core").PluginDef;
    export default _default;
}

declare module '@fullcalendar/yearview/SimpleDayGrid' {
    import { DateProfile, EventStore, EventUiHash, DateSpan, EventInteractionState, Duration, DateComponent, DateRange, Slicer, Hit, ComponentContext } from '@fullcalendar/core';
    import { default as DayGrid, DayGridSeg } from '@fullcalendar/yearview/DayGrid';
    import { default as DayTable } from '@fullcalendar/yearview/DayTable';
...
declare module '@fullcalendar/yearview/DayGrid' {
    import { PositionCache, DateMarker, DateComponent, EventSegUiInteractionState, Seg, DateProfile } from '@fullcalendar/core';
    import Popover from '@fullcalendar/yearview/Popover';
    import DayGridEventRenderer from '@fullcalendar/yearview/DayGridEventRenderer';
    import DayTile from '@fullcalendar/yearview/DayTile';
...
declare module '@fullcalendar/yearview/DayGridView' {
    import { DayHeader, ComponentContext, ViewSpec, DateProfileGenerator, DateProfile, ViewProps } from '@fullcalendar/core';
    import AbstractDayGridView from '@fullcalendar/yearview/AbstractDayGridView';
    import SimpleDayGrid from '@fullcalendar/yearview/SimpleDayGrid';
    import DayTable from '@fullcalendar/yearview/DayTable';
    export { DayGridView as default, DayGridView };
...
declare module '@fullcalendar/yearview/DayBgRow' {
...
declare module '@fullcalendar/yearview/DayTable' {
...
declare module '@fullcalendar/yearview/Popover' {
...
declare module '@fullcalendar/yearview/DayGridEventRenderer' {
    import { Seg } from '@fullcalendar/core';
    import DayGrid from '@fullcalendar/yearview/DayGrid';
    import SimpleDayGridEventRenderer from '@fullcalendar/yearview/SimpleDayGridEventRenderer';
...
declare module '@fullcalendar/yearview/DayTile' {
...
declare module '@fullcalendar/yearview/SimpleDayGridEventRenderer' {
