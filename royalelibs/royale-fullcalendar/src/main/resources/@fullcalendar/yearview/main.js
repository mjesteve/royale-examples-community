    ...
    var DayGrid = /** @class */ (function (_super) {
        ...
        DayGrid.prototype.renderDayRowHtml = function (row, isRigid) {
            ...
            return '' +
                ...
                '<div class="fc-row-monthname fc-content"><span>' + moment__default(this.props.cells[row][0].date).format('MMM') + '</span></div>' +
                '<div class="fc-bg">' +
        ...
        DayGrid.prototype.renderNumberCellHtml = function (date) {
            ...
            if (isDayNumberVisible) {
                html += core.buildGotoAnchorHtml(view, date, { 'class': 'fc-day-number' }, '<span class="fc-day-number-weekday">' + moment__default(date).format('dd') + '</span>' + dateEnv.format(date, DAY_NUM_FORMAT) // inner HTML
                );
            }
            html += '</td>';
            return html;
