package org.apache.royale.community.jewel.beads.controllers
{
	 ...
	 */
	public class ComboBoxControllerJwExt implements IBeadController
	{
		/**
		 *  constructor.
		 *
		 ...
		 *  @productversion Royale 0.9.4
		 */
		public function ComboBoxControllerJwExt()
		{
		}
		...
		protected function textInputKeyEventHandler(event:KeyboardEvent):void
		{
			...
			/* CHANGE: Add UP */
			if(event.key === NavigationKeys.DOWN || event.key === NavigationKeys.UP)
			{
				keyPressed = true;
