...
//
////////////////////////////////////////////////////////////////////////////////
package org.apache.royale.community.beads.controllers
{
	...
	public class PageNavigatorButtonBarController extends ListSingleSelectionMouseController
	{
		...
		override public function set strand(value:IStrand):void
		{
			...
			if (listModel is IJewelSelectionModel && !(IJewelSelectionModel(listModel).hasDispatcher)) {
                ...
                //IEventDispatcher(listModel).addEventListener('selectedIndexChanged', modelChangeHandler);
				IEventDispatcher(listModel).addEventListener('selectedIndexChanged', selectedIndexChangeHandler);
            }
		}
