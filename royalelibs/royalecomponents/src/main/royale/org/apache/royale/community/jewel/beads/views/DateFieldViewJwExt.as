package org.apache.royale.community.jewel.beads.views
{
	 ...
	 */
	public class DateFieldViewJwExt extends BeadViewBase implements IComboBoxViewJwExt
	{
		/**
		 *  constructor.
		 *
		 ...
		 *  @productversion Royale 0.9.4
		 */
		public function DateFieldViewJwExt()
		{
		}
		...
		override public function set strand(value:IStrand):void
		{
			...
			if( (value as IStrandWithResetButton).withResetButton )
			{
