package org.apache.royale.community.inspiretree.history
{
    ...
    COMPILE::JS
	public class InspireTreeIconBeadTest1  extends Strand implements IBead
	{
		/**
		 *  constructor
		 *
		...
		public function InspireTreeIconBeadTest1()
		{
			super();
		}
		...
		{
			var prop:Object = {typeIconsSet:_typeIconsSet, parentIcon:_parentIcon, parentOpenIcon:_parentOpenIcon,
			...
			if(collectionIcons == null)
				collectionIcons = { typeIconsSet:'default' };

			if(collectionIcons.hasOwnProperty('typeIconsSet'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('typeIconsSet');

			if(_typeIconsSet != prop.typeIconsSet )
			{
				var deleteClass:Boolean = _typeIconsSet == 'customClasses' && prop.typeIconsSet != 'customClasses' ? true : false;
				var deleteCustom:Boolean = _typeIconsSet == 'custom' && prop.typeIconsSet != 'custom' ? true : false;
				var deleteNone:Boolean = _typeIconsSet == 'none' && prop.typeIconsSet != 'none' ? true : false;

				if(deleteClass || deleteCustom || deleteNone)
				{
			...
			if(collectionIcons.hasOwnProperty('parentIcon'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('parentIcon');

			if(collectionIcons.hasOwnProperty('parentOpenIcon'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('parentOpenIcon');

			if(collectionIcons.hasOwnProperty('parentSelectedIcon'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('parentSelectedIcon');

			if(collectionIcons.hasOwnProperty('parentOpenSelectedIcon'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('parentOpenSelectedIcon');

			if(collectionIcons.hasOwnProperty('childIcon'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('childIcon');

			if(collectionIcons.hasOwnProperty('childSelectedIcon'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('childSelectedIcon');

			if(collectionIcons.hasOwnProperty('minusIcon'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('minusIcon');

			if(collectionIcons.hasOwnProperty('plusIcon'))
				prop.typeIconsSet = collectionIcons.hasOwnProperty('plusIcon');

			if(prop.typeIconsSet == 'none')
			{
...
*/
    ...
    COMPILE::SWF
	public class InspireTreeIconBeadTest1
	{
    }
}
