...
(function() { // webpackBootstrap
  ...
  ! function() {
      ...
      function _createForOfIteratorHelper(o, allowArrayLike) {
          ...
          if (!it) {
              if (Array.isArray(o) || (it = virtual_select_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") {
                  if (it) o = it;
                  var i = 0;
                  var F = function F() {};
                  return {
          ...
          virtual_select_createClass(VirtualSelect, [{
              ...
              value: function getOptionsCount(count) {
                  if (this.showAsPopup) {
                    ...
                    // Custom Royale.
                    if(count < 0) {
                        var availableHeight2 = this.$ele.clientHeight;
                        if (this.hasSearchContainer) {
                          availableHeight2 -= searchHeight;
                        }
  
                        count = Math.floor(availableHeight2 / this.optionHeight);
                    }
                  }
  ...
  ! function() {
      ...
      ! function() {
          ...
          var r = ["top", "bottom", "left", "right"].map((function(e) {
                  ...
                  return t = e, (o = [{
                      ...
                      value: function() {
                          ...
                          var e, t, o, n = window.innerWidth,
                              ...
                              C = k,
                              S = this.position,
                              P = this.secondaryPosition,
                              O = y / 2 - h / 2,
                              A = m / 2 - u / 2,
                              x = this.margin,
                              T = this.transitionDistance,
                              H = window.scrollY - c,
                              I = s + H,
                              F = window.scrollX - v,
                              M = n + F,
                              L = this.offset;
                          L && (H += L, I -= L, F += L, M -= L), "auto" === S && (S = i.getMoreVisibleSides(this.$triggerEle).vertical);
                          var j = {
                                  top: {
                                      top: C - u - x,
                                      left: D + O
                              ...
                              z = j[S];
                          if (C = z.top, D = z.left, P && ("top" === P ? C = k : "bottom" === P ? C = k + m - u : "left" === P ? D = $ : "right" === P && (D = $ + y - h)), D < F ? "left" === S ? o = "right" : D = F + v > w ? w - v : F : D + h > M && ("right" === S ? o = "left" : D = M + v < b ? b - f : M - h), C < H ? "top" === S ? o = "bottom" : C = H + c > E ? E - c : H : C + u > I && ("bottom" === S ? o = "top" : C = I + c < g ? g - d : I - u), o) {
                              var R = j[o];
                              "top" === (S = o) || "bottom" === S ? C = R.top : "left" !== S && "right" !== S || (D = R.left)
                          }
                          "top" === S ? (e = C + T, t = D) : "right" === S ? (e = C, t = D - T) : "left" === S ? (e = C, t = D + T) : (e = C - T, t = D);
                          var U = "translate3d(".concat(t, "px, ").concat(e, "px, 0)");
                          if (i.setStyle(this.$popperEle, "transform", U), i.setData(this.$popperEle, "fromLeft", t), i.setData(this.$popperEle, "fromTop", e), i.setData(this.$popperEle, "top", C), i.setData(this.$popperEle, "left", D), i.removeClass(this.$popperEle, r.join(" ")), i.addClass(this.$popperEle, "position-".concat(S)), this.hasArrow) {
                              var B = 0,
                                  q = 0,
                                  W = D + v,
                                  K = C + c,
                                  ...
                                  X = a[S] || "";
                              "top" === S || "bottom" === S ? (B = y / 2 + b - W) < V ? B = V : B > h - V && (B = h - V) : "left" !== S && "right" !== S || ((q = m / 2 + g - K) < V ? q = V : q > u - V && (q = u - V)), i.setStyle(this.$arrowEle, "transform", "translate3d(".concat(B, "px, ").concat(q, "px, 0) ").concat(X))
                          }
      ...
      function() {
          ...
          var t = function() {
              ...
              }], (i = null) && e(o.prototype, i), n && e(o, n), t
          }();
          ...
          var r = function() {
              ...
              }], (r = null) && n(i.prototype, r), a && n(i, a), e
          }();
              ...
              l = function() {
                  ...
                  return o = e, n = [{
                      ...
                      value: function(t) {
                          ...
                          if (o) {
                              ...
                              return o.forEach((function(o) {
                                  t.ele = o, e.destory(o), n.push(new e(t))
                              })), i ? n[0] : n
                          }
                      }
                  }, {
                      ...
                      value: function(e) {
                          ...
                          n && (a = t.removeArrayEmpty(a.split(" "))).forEach((function(e) {
                              var a = "".concat(s, "-").concat(e),
                                  p = o.events[a];
                              p || (p = o[s].bind(o), l && (p = t.throttle(p, l)), o.events[a] = p), "add" === i ? r.addEvent(n, e, p) : r.removeEvent(n, e, p)
                          }))
                      }
                  }, {
                      ...
                      value: function() {
                          ...
                          }), 2e3) : r.removeClass(this.$popover, "pop-comp-disable-events"), this.disableUpdatePosition || this.addScrollEventListeners(), "function" == typeof this.afterShowCallback && this.afterShowCallback(this)
                      }
                  }, {
                      key: "afterHide",
                      value: function() {
