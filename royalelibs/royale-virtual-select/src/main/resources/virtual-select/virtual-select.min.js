    ...
    function e(e) {
        return function(e) {
            ...
            if (e) {
                ...
                "Map" === i || "Set" === i ? Array.from(e) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? t(e, o) : void 0
            }
        }(e) || function() {
    ...
    var o = function() {
        ...
        return (o = [{
            ...
            value: function(e, t, o) {
                if (e) {
                    var i = e ? e.dataset[t] : "";
                    return "number" === o ? i = parseFloat(i) || 0 : "true" === i ? i = !0 : "false" === i && (i = !1),
                    i
                }
            }
        }, {
      ...
      , n = function() {
        ...
        return (t = [{
            ...
            value: function() {
                ...
                e && this.$triggerEle && (o.setStyle(e, "zIndex", this.zIndex),
                this.setPosition())
            }
        }, {
            key: "setProps",
            ...
            value: function() {
                ...
                var e, t, n, a = window.innerWidth, r = window.innerHeight, l = o.getAbsoluteCoords(this.$popperEle), p = o.getAbsoluteCoords(this.$triggerEle), h = l.width, c = l.height, u = l.top, d = l.right, v = l.bottom, f = l.left, y = p.width, m = p.height, g = p.top, b = p.right, O = p.bottom, S = p.left, w = g - u, x = S - f, k = x, C = w, E = this.position, $ = this.secondaryPosition, A = y / 2 - h / 2, D = m / 2 - c / 2, T = this.margin, V = this.transitionDistance, P = window.scrollY - u, M = r + P, I = window.scrollX - f, H = a + I, F = this.offset;
                F && (P += F,
                M -= F,
                I += F,
                H -= F),
                "auto" === E && (E = o.getMoreVisibleSides(this.$triggerEle).vertical);
                var W = {
                    top: {
                        top: C - c - T,
                        left: k + A
                ...
                if (C = N.top,
                k = N.left,
                $ && ("top" === $ ? C = w : "bottom" === $ ? C = w + m - c : "left" === $ ? k = x : "right" === $ && (k = x + y - h)),
                k < I ? "left" === E ? n = "right" : k = I + f > b ? b - f : I : k + h > H && ("right" === E ? n = "left" : k = H + f < S ? S - d : H - h),
                C < P ? "top" === E ? n = "bottom" : C = P + u > O ? O - u : P : C + c > M && ("bottom" === E ? n = "top" : C = M + u < g ? g - v : M - c),
                n) {
                    var L = W[n];
                    "top" === (E = n) || "bottom" === E ? C = L.top : "left" !== E && "right" !== E || (k = L.left)
                }
                "top" === E ? (e = C + V,
                t = k) : "right" === E ? (e = C,
                t = k - V) : "left" === E ? (e = C,
                t = k + V) : (e = C - V,
                t = k);
                var B = "translate3d(".concat(t, "px, ").concat(e, "px, 0)");
                if (o.setStyle(this.$popperEle, "transform", B),
                ...
                this.hasArrow) {
                    var j = 0
                      ...
                      , R = k + f
                      , z = C + u
                      , K = this.$arrowEle.offsetWidth / 2
                      , G = s[E] || "";
                    "top" === E || "bottom" === E ? (j = y / 2 + S - R) < K ? j = K : j > h - K && (j = h - K) : "left" !== E && "right" !== E || ((q = m / 2 + g - z) < K ? q = K : q > c - K && (q = c - K)),
                    o.setStyle(this.$arrowEle, "transform", "translate3d(".concat(j, "px, ").concat(q, "px, 0) ").concat(G))
                }
                ...
                this.exitDelayTimeout = setTimeout((function() {
                    if (e.$popperEle) {
                        ...
                        e.hideDurationTimeout = setTimeout((function() {
                            o.hide(e.$popperEle),
                            "function" == typeof e.afterHideCallback && e.afterHideCallback(i)
                        }
                        ), a)
                    }
                }
            ...
            value: function() {
                ...
                o.show(this.$popperEle, "inline-flex"),
                o.setStyle(this.$popperEle, "transform", "translate3d(".concat(e, "px, ").concat(t, "px, 0)"))
            }
        }]) && function(e, t) {
            for (var o = 0; o < t.length; o++) {
                var i = t[o];
...
function() {
        ...
        (i = [{
            ...
            value: function(e, t) {
                ...
                return function() {
                    ...
                    clearTimeout(o),
                    l <= 0 ? (i = r,
                    e.apply(void 0, n)) : o = setTimeout((function() {
                        e.apply(void 0, n)
                    }
                    ), l)
                }
    ...
    var n = function() {
        ...
        (n = [{
            ...
            key: "getElement",
            value: function(e) {
                return e && ("string" == typeof e ? e = document.querySelector(e) : void 0 !== e.length && (e = e[0])),
                e || null
            }
        }, {
            key: "getElements",
            ...
            value: function(e) {
                ...
                for (var t = [window], o = e.parentElement; o; ) {
                    var i = getComputedStyle(o).overflow;
                    -1 === i.indexOf("scroll") && -1 === i.indexOf("auto") || t.push(o),
                    o = o.parentElement
                }
                return t
            }
    ...
    var r = {
      ...
      , l = function() {
        ...
        (i = [{
            key: "init",
            value: function() {
                this.$popover && (this.setElementProps(),
                this.renderArrow(),
                this.initPopper(),
                this.addEvents())
            }
            ...
            value: function(e) {
                ...
                s && (a = t.removeArrayEmpty(a.split(" "))).forEach((function(e) {
                    ...
                    l && (p = t.throttle(p, l)),
                    o.events[a] = p),
                    "add" === i ? n.addEvent(s, e, p) : n.removeEvent(s, e, p)
                }
                ))
            }
        }, {
            ...
            key: "show",
            value: function() {
                this.isShown() || (this.isShownForOtherTrigger() ? this.showAfterOtherHide() : (n.addClass(this.$popover, "pop-comp-disable-events"),
            ...
            value: function() {
                ...
                "function" == typeof this.afterShowCallback && this.afterShowCallback(this)
            }
        }, {
            key: "afterHide",
            value: function() {
                n.removeClass(this.$ele, "pop-comp-active"),
                "function" == typeof this.afterHideCallback && this.afterHideCallback(this)
            }
        }, {
            key: "renderArrow",
            value: function() {
                if (!this.hideArrowIcon) {
                    ...
                    e || (this.$popover.insertAdjacentHTML("afterbegin", '<i class="pop-comp-arrow"></i>'),
...
function() {
    ...
    var s = function() {
        ...
        a = [{
            ...
            value: function(e) {
                var t = !1;
                return e ? Array.isArray(e) ? 0 === e.length && (t = !0) : "object" === o(e) && 0 === Object.keys(e).length && (t = !0) : t = !0,
                t
            }
        }, {
            key: "isNotEmpty",
            ...
            value: function(t, o, i) {
                if (!Array.isArray(t) || !t.length || !o)
                    return t;
                i && (t = e(t));
                var s = t.indexOf(o);
                return -1 !== s && t.splice(s, 1),
                t
            }
        }, {
            key: "removeArrayEmpty",
    ...
    var l = function() {
        ...
        i = [{
            ...
            value: function(e, t) {
                var o = "";
                for (var i in e)
                    o += "".concat(i, ": ").concat(e[i], ";");
                return o && !t && (o = 'style="'.concat(o, '"')),
                o
            }
        }, {
    ...
    function c(e, t) {
        if (e) {
            ...
            var o = Object.prototype.toString.call(e).slice(8, -1);
            return "Object" === o && e.constructor && (o = e.constructor.name),
            "Map" === o || "Set" === o ? Array.from(e) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? u(e, t) : void 0
        }
    }
    function u(e, t) {
        (null == t || t > e.length) && (t = e.length);
    ...
    var v = {
      ...
      , f = function() {
        ...
        i = [{
            ...
            value: function(e, t) {
                this.virtualSelect.setOptionsMethod(e, t)
            }
        }, {
        ...
        (o = [{
            ...
            value: function() {
                if (this.$ele) {
                    ...
                    this.keepAlwaysOpen ? e += " keep-always-open" : e += " closed",
                    ...
                    this.hasDropboxWrapper ? (this.$allWrappers = [this.$wrapper, this.$dropboxWrapper],
                    this.$dropboxContainer = this.$dropboxWrapper.querySelector(".vscomp-dropbox-container"),
                    l.addClass(this.$dropboxContainer, "pop-comp-wrapper")) : (this.$allWrappers = [this.$wrapper],
            ...
            value: function(e) {
                ...
                return this.hasDropboxWrapper = !1,
                s
            }
        }, {
            key: "renderOptions",
            value: function() {
                var e, t = this, o = "", i = this.getVisibleOptions(), s = "", n = "", a = !(!this.markSearchResults || !this.searchValue), r = this.labelRenderer, p = "function" == typeof r, h = l.getStyleText({
                    height: this.optionHeight + "px"
                });
                if (a && (e = new RegExp("(".concat(this.searchValue, ")"),"gi")),
                this.multiple && (s = '<span class="checkbox-icon"></span>'),
                this.allowNewOption) {
                    var c = this.getTooltipAttrText("New Option");
                    n = '<span class="vscomp-new-option-icon" '.concat(c, "></span>")
                }
                i.forEach((function(i) {
                    var l, c = "vscomp-option", u = t.getTooltipAttrText("", !0), d = s, v = "", f = "";
                    i.isFocused && (c += " focused"),
                    i.isDisabled && (c += " disabled"),
                    i.isGroupTitle ? (c += " group-title",
                    d = "") : i.isSelected && (c += " selected"),
                    i.isGroupOption && (c += " group-option"),
                    l = p ? r(i) : i.label,
                    i.description && (f = '<div class="vscomp-option-description" '.concat(u, ">").concat(i.description, "</div>")),
                    i.isCurrentNew ? (c += " current-new",
                    v += n) : a && !i.isGroupTitle && (l = l.replace(e, "<mark>$1</mark>")),
                ...
                var u = !this.options.length && !this.hasServerSearch
                  , d = !u && !i.length;
                (!this.allowNewOption || this.hasServerSearch || this.showOptionsOnlyOnSearch) && l.toggleClass(this.$allWrappers, "has-no-search-results", d),
                l.toggleClass(this.$allWrappers, "has-no-options", u),
            ...
            value: function() {
                if (this.hasSearchContainer) {
                    ...
                    this.hasSearch && (t = '<input type="text" class="vscomp-search-input" placeholder="'.concat(this.searchPlaceholderText, '">\n      <span class="vscomp-search-clear">&times;</span>'));
            ...
            value: function(e) {
                e.preventDefault(),
                this.isOpened() ? this.focusOption("previous") : this.openDropbox()
            }
        }, {
            ...
            value: function() {
                ...
                this.renderSearch(),
                this.showAsPopup || this.setDropboxWrapperWidth(),
                this.setOptionsHeight(),
                this.setVisibleOptions(),
                this.setOptionsContainerHeight(),
                this.addEvents(),
                this.setMethods(),
                this.keepAlwaysOpen || this.showAsPopup || this.initDropboxPopover(),
                this.initialSelectedValue ? this.setValueMethod(this.initialSelectedValue, this.silentInitialValueSet) : this.autoSelectFirstOption && this.visibleOptions.length && this.setValueMethod(this.visibleOptions[0].value, this.silentInitialValueSet),
            ...
            value: function(e) {
                ...
                this.hideValueTooltipOnSelectAll = t(e.hideValueTooltipOnSelectAll),
                this.showOptionsOnlyOnSearch = t(e.showOptionsOnlyOnSearch),
                this.selectAllOnlyVisible = t(e.selectAllOnlyVisible),
                this.alwaysShowSelectedOptionsCount = t(e.alwaysShowSelectedOptionsCount),
                this.disableAllOptionsSelectedText = t(e.disableAllOptionsSelectedText),
                ...
                this.initialSelectedValue = 0 === e.selectedValue ? "0" : e.selectedValue,
                this.selectedValues = [],
                ...
                (void 0 === e.search && this.multiple || this.allowNewOption || this.showOptionsOnlyOnSearch) && (this.hasSearch = !0),
                this.hasServerSearch = "function" == typeof this.onServerSearch,
                (this.maxValues || this.hasServerSearch || this.showOptionsOnlyOnSearch) && (this.disableSelectAll = !0),
            ...
            value: function(e) {
                ...
                return e.hasOptionDescription && (t.optionsCount = 4,
                t.optionHeight = "50px"),
                Object.assign(t, e)
            }
        }, {
            ...
            value: function() {
                ...
                this.hasDropboxWrapper && (this.$dropboxWrapper.virtualSelect = this)
            }
        }, {
            key: "setValueMethod",
            value: function(e, t) {
                ...
                this.options.forEach((function(e) {
                    !0 !== i[e.value] || e.isDisabled || e.isGroupTitle ? e.isSelected = !1 : (e.isSelected = !0,
                    o.push(e.value))
                }
                )),
                this.multiple || (o = o[0]),
            ...
            value: function() {
                ...
                t && e.length && this.options.forEach((function(e) {
                    return e.isDisabled = !0 === o[e.value],
                    e
                }
                ))
            }
            ...
            value: function(e) {
                ...
                e.forEach((function e(s) {
                    ...
                    if (o && (g.isDisabled = !0 === v[f]),
                    s.isGroupOption && (g.isGroupOption = !0,
                    g.groupIndex = s.groupIndex),
                    l && (g.description = p(s[a])),
                    t.push(g),
                    u++,
                    m) {
                        var b = g.index;
            ...
            value: function() {
                ...
                this.showSelectedOptionsFirst && this.selectedValues.length && (e = this.hasOptionGroup ? this.sortOptionsGroup(e) : this.sortOptions(e)),
            ...
            value: function() {
                ...
                e = e.filter((function(e) {
                    var t = !1;
                    return e.isVisible && !e.isCurrentNew && (t = n >= o && n <= s,
                    e.visibleIndex = n,
                    n++),
                    t
                }
            ...
            value: function(e) {
                ...
                this.$options.style.transform = "translate3d(0, ".concat(t, "px, 0)"),
            ...
            value: function() {
                ...
                t.forEach((function(t) {
                    ...
                    l.setData(i.querySelector(".vscomp-option-text"), "tooltip", t.label),
                    o && l.setData(i.querySelector(".vscomp-option-description"), "tooltip", t.description)
                }
                ))
            }
        }, {
            ...
            value: function(e, t) {
                ...
                this.setValueText(),
                l.toggleClass(this.$allWrappers, "has-value", s.isNotEmpty(this.selectedValues)),
                l.toggleClass(this.$allWrappers, "max-value-selected", this.isMaxValuesSelected),
            ...
            value: function() {
                ...
                if (p && this.hideValueTooltipOnSelectAll)
                    a.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(i, ")");
                else {
                    var h = {};
                    o.forEach((function(e) {
                        h[e] = !0
                    ...
                    var g = i - s;
                    g > 0 && t.push('<span class="vscomp-value-tag more-value-count">+ '.concat(g, " ").concat(this.moreText, "</span>"));
                    var b = e.join(", ");
                    if ("" === b)
                        a.innerHTML = this.placeholder;
                    else if (a.innerHTML = b,
                    this.multiple) {
                        ...
                        if (l.hasEllipsis(a) || O || this.alwaysShowSelectedOptionsCount || n) {
                            ...
                            if (O && (S += ' / <span class="vscomp-max-value-count">'.concat(O, "</span>")),
                            p)
                                a.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(i, ")");
                            else if (n)
                                a.innerHTML = t.join("");
                            else {
                                var w = 1 === i ? this.optionSelectedText : this.optionsSelectedText;
                                a.innerHTML = "".concat(S, " ").concat(w)
                            }
                        } else
                            t = []
                    }
            ...
            value: function() {
                var e, t = 0, o = !1, i = this.searchValue, s = this.showOptionsOnlyOnSearch, n = this.isOptionVisible.bind(this);
                this.hasOptionGroup && (e = this.getVisibleOptionGroupsMapping(i)),
                this.options.forEach((function(a) {
                    var r;
                    a.isCurrentNew || (s && !i ? (a.isVisible = !1,
                    r = {
                        isVisible: !1,
                        hasExactOption: !1
                    }) : r = n(a, i, o, e),
                ...
                this.allowNewOption && (i && !o ? (this.setNewOption(),
                t++) : this.removeNewOption()),
            ...
            value: function(e) {
                var t;
                e ? this.showAsPopup && (this.optionsCount = this.getOptionsCount(),
                t = this.getOptionsHeight(),
                this.optionsHeight = t) : (t = this.optionsHeight,
                this.keepAlwaysOpen && (l.setStyle(this.$noOptions, "height", t),
            ...
            value: function(e) {
                ...
                if (t) {
                    ...
                    if (o) {
                        ...
                        e ? (s.isNew = !0,
                        this.newValues.push(t)) : s.isCurrentNew = !0,
                        this.addOption(s)
                    }
                }
            }
            ...
            value: function(e) {
                var t;
                return e && this.options.some((function(o) {
                    if (o.value == e)
                        return t = o.index,
                        !0
                }
            ...
            value: function(e) {
                this.isSilentOpen = e,
                e || l.dispatchEvent(this.$ele, "beforeOpen"),
                l.removeClass(this.$allWrappers, "closed"),
                this.dropboxPopover ? this.dropboxPopover.show() : this.afterShowPopper()
            }
        }, {
            key: "afterShowPopper",
            value: function() {
                ...
                this.isSilentOpen = !1,
                e || (this.moveSelectedOptionsFirst(),
                l.addClass(this.$allWrappers, "focused"),
                this.showAsPopup ? (l.addClass(this.$body, "vscomp-popup-active"),
                this.isPopupActive = !0) : this.focusSearchInput(),
            ...
            value: function(e) {
                ...
                this.keepAlwaysOpen ? this.removeOptionFocus() : (e || l.dispatchEvent(this.$ele, "beforeClose"),
                this.dropboxPopover ? this.dropboxPopover.hide() : this.afterHidePopper())
            }
        }, {
            key: "afterHidePopper",
            value: function() {
                ...
                this.removeOptionFocus(),
                e || this.isPopupActive && (l.removeClass(this.$body, "vscomp-popup-active"),
            ...
            value: function() {
                this.showSelectedOptionsFirst && (this.setSortedOptions(),
                this.$optionsContainer.scrollTop && this.selectedValues.length ? this.scrollToTop() : this.setVisibleOptions())
            }
        }, {
            key: "toggleDropbox",
            value: function() {
            ...
            value: function(e, t) {
                ...
                if (t)
                    ...
                    o = this.getSibling(i, e);
                else {
                    var s = this.getFirstVisibleOptionIndex();
                    o = this.$dropboxContainer.querySelector('.vscomp-option[data-visible-index="'.concat(s, '"]')),
                    (l.hasClass(o, "disabled") || l.hasClass(o, "group-title")) && (o = this.getSibling(o, "next"))
                }
                o && o !== i && (i && l.removeClass(i, "focused"),
            ...
            value: function(e) {
                if (e || (e = this.$dropboxContainer.querySelector(".vscomp-option.focused")),
                e) {
                    var t, o = this.$optionsContainer.getBoundingClientRect(), i = e.getBoundingClientRect(), s = o.top, n = o.bottom, a = o.height, r = i.top, p = i.bottom, h = i.height, c = e.offsetTop, u = l.getData(this.$options, "top", "number");
            ...
            value: function(e) {
                if (e) {
                    ...
                    var o = this.selectedValues
                      , i = l.getData(e, "value")
                      , n = l.getData(e, "index");
                    if (this.toggleSelectedProp(n, t),
                    t) {
                        if (this.multiple)
                            o.push(i),
                            this.toggleAllOptionsClass();
                        else {
                            o.length && this.toggleSelectedProp(this.getOptionIndex(o[0]), !1),
                            o = [i];
                            var a = this.$dropboxContainer.querySelector(".vscomp-option.selected");
                            a && l.toggleClass(a, "selected", !1),
                            this.closeDropbox()
                        }
                        l.toggleClass(e, "selected")
                    } else
                        this.multiple && (l.toggleClass(e, "selected"),
                        s.removeItemFromArray(o, i),
            ...
            value: function(e) {
                if (this.multiple && !this.disableSelectAll) {
                    ...
                    this.options.forEach((function(i) {
                        i.isDisabled || i.isCurrentNew || i.isGroupTitle || (!e || o && !i.isVisible ? i.isSelected = !1 : (i.isSelected = !0,
                        t.push(i.value)))
                    }
                    )),
            ...
            value: function(e) {
                if (this.multiple) {
                    ...
                    this.selectAllOnlyVisible && t ? this.isAllSelected = this.isAllOptionsSelected() : this.isAllSelected = e
                }
            }
        }, {
            ...
            value: function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                this.focusedOptionIndex && this.setOptionProp(this.focusedOptionIndex, "isFocused", !1),
            ...
            value: function(e, t) {
                if (e) {
                    ...
                    e.index = this.lastOptionIndex;
                    var o = this.getOptionObj(e);
                    this.options.push(o),
                    this.sortedOptions.push(o),
                    t && (this.visibleOptionsCount++,
            ...
            value: function(e, t, o, i) {
                var s = e.label.toLowerCase()
                  ...
                  , a = e.alias
                  , r = -1 !== s.indexOf(t);
                return e.isGroupTitle && (r = i[e.index]),
                a && !r && (r = -1 !== a.indexOf(t)),
